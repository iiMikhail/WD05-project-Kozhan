				...
				<div class="add-post-content"> 
					...
					<form 	enctype="multipart/form-data" 
						...
						<div class="add-post-content__name mt-40">
							...
							<input class="input" name="item-name" id="add-post-name" type="text" placeholder="Введите название товара" />
						</div>
						...
						<div class="add-post-content__main mt-30">
							...
							<textarea id="editor1" class="textarea" name="item-desc" id="add-post-city" placeholder="Введите описание товара"></textarea>
						</div>

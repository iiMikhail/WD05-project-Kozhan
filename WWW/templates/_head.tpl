...
<head>
	...
	<!-- <link rel="stylesheet" href="../templates/style/css/main.css" /> -->
	<link rel="stylesheet" href="<?php echo HOST?>templates/style/css/main.css" /><!-- endbuild -->
	<!-- <link rel="stylesheet" href="<?php echo HOST?>libs/bootstrap-4.0.0-dist/css/bootstrap.css"> -->
